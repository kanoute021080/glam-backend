...
app.get("/client/lasavane", (req, res) => res.sendFile(path.join(__dirname, "client-restaurant.html")));
app.get("/dashboard/lasavane", (req, res) => res.sendFile(path.join(__dirname, "dashboard-restaurant.html")));
