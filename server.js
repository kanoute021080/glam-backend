...
app.get("/client/afghan1", (req, res) => res.sendFile(__dirname + "/public/client-restaurant.html"));
app.get("/dashboard/afghan1", (req, res) => res.sendFile(__dirname + "/public/dashboard-restaurant.html"));
